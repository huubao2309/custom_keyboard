...
class KeyboardController extends ValueNotifier<TextEditingValue> {
  ...
  set value(TextEditingValue newValue) {
    newValue = newValue.copyWith(
      // fix bugs caused by default values
      composing: TextRange(
  ...
  /// delete a character, generally used for the keyboard delete key
  deleteOne() {
  ...
  /// add text at the cursor position, generally used for keyboard input
